    ...
    <main className="min-h-screen bg-[#FAF7F2] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-sage">
          ...
          <Link href="/login" className="font-medium text-rust hover:text-rust/80 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-2xl sm:px-10 border border-rust/10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-dm-mono uppercase tracking-widest text-sage font-semibold">Full Name</label>
              <input
                required
                type="text"
                value={name}
