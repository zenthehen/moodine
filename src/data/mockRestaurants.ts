...
export const mockRestaurants: Restaurant[] = [
  // Romantic
  {
    ...
    location: "Lazimpat",
    description:
      "An intimate dining experience with soft candlelight and an exceptional wine list.",
    priceLevel: "$$$$",
  ...
  },
  {
    ...
    description:
      "Rooftop garden draped in fairy lights, perfect for a romantic evening out.",
    priceLevel: "$$$",
  ...
  // Fun & Lively
  {
    ...
    location: "Thamel",
    description:
      "Bustling rooftop setting with live music, fantastic cocktails, and vibrant energy.",
    priceLevel: "$$",
  ...
  },
  {
    ...
    location: "Thamel",
    description:
      "Craft beer and DJ weekends. Loud, fun, and packed with locals and travelers.",
    priceLevel: "$$",
  ...
  // Chill & Casual
  {
    ...
    location: "Lazimpat",
    description:
      "Quiet, cozy corner with books and specialty coffee. Great for focused work or a quiet chat.",
    priceLevel: "$",
  ...
  // Business
  {
    ...
    description:
      "A classic setting for power lunches and formal business meetings with impeccable service.",
    priceLevel: "$$$$",
    vibe: { intimacy: 4, energy: 2, formality: 9, noise: 2, outdoorsy: 1 },
    imageUrl:
      "https://images.unsplash.com/photo-1414235077428-33898ed1e830?q=80&w=800&auto=format&fit=crop",
  },
  ...
  // Family
  {
    ...
    location: "Patan",
    description:
      "Spacious and welcoming, offering unlimited dal bhat in a family-friendly atmosphere.",
    priceLevel: "$$",
  ...
  // Adventure
  {
    ...
    description:
      "Stunning lakeside views and adventurous fusion dishes for the bold eater.",
    priceLevel: "$$",
...
export function calculateMatchScore(
  restaurantDims: VibeDimensions,
  moodProfile: VibeDimensions,
): number {
  let diff = 0;
